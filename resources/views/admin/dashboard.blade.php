            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y border-t border-slate-100">
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-8 py-6 font-black {{ $trx->status == 'pending' ? 'text-slate-500' : 'text-indigo-600' }}">
                            Rp {{ number_format($trx->total_price, 0, ',', '.') }}
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="4" class="px-8 py-10 text-center text-slate-500 font-medium">Belum ada transaksi terakhir.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
