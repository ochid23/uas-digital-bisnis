...
<main class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-2 space-y-12">
            ...
            <div class="prose prose-slate max-w-none">
                ...
                <p class="text-lg text-slate-600 leading-relaxed whitespace-pre-wrap">{{ $event->description }}</p>
            </div>
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div>
                        ...
                        <h2 class="text-5xl font-black">{{ $event->price == 0 ? 'Gratis' : 'Rp ' . number_format($event->price, 0, ',', '.') }} <span class="text-lg font-medium text-indigo-200">/
                                orang</span></h2>
